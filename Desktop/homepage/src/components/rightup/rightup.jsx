...
const Rightup = () => {
    const setname = useStore(state => state.sethook)
    return(
        <div className={s.all}>
            <div className={s.text}>本站链接：</div>
            <div className={s.mods}>
                {/* <div className={s.mod} onClick={()=>{setname("set")}}>
                    ...
                    <div className={s.icont}>设置</div>
                </div> */}
                <div className={s.mod} onClick={()=>{setname("web")}}>
                    <div className={s.icon}>
                    ...
                    <div className={s.icont}>关于网站</div>
                </div>
            </div>
        </div>
    )
